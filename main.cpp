...
int32 update_sun() {
      ...
      /*   FloatPoint gps = own_vessel.get_pos();
         ...
         struct tm* localTime = std::localtime(&global_time); // ѕреобразование в структуру tm
...
{
      // считаем наш тестовый пр€моугольник (view_box), это видима€ часть
     //все вычислени€ приводим к центру (0,0)
